...
#include "IOVec.h"
#include "User.h"
#include "DataDict.h"   // lei 2022.04.30: added for test
...
tUser	User;
int     counter;        // lei 2022.04.30: added for test
...
User_DeclQuants (void)
{
    ...
    DDefInt(NULL, "Training.Counter", "", &counter, DVA_None);      // lei 2022.04.30: added for test
...
{
    counter = 0;        // lei 20222.04.30: added for test
    return 0;
}
...
User_Calc (double dt)
{
    ...
    // if (SimCore.CycleNo %1000 == 0)     // lei 2022.04.30: added for test
    // {
    //     Log("User_Calc\n");
    // }
    
    counter++;      // lei 2022.04.30: added for test
